...
function ruleBasedPlanningInput(params: {
  seed: FollowupSeed;
...
export async function POST(req: Request) {
  try {
    ...
    try {
      ...
      const planningInput = cleanPlanningInput({
        seed,
        messages,
        slots,
        input: parsed,
      ...
      const fallback: FinalizeChatResponse = {
        ...
        planningInput: ruleBasedPlanningInput({ seed, messages, slots }),
    ...
    const fallback: FinalizeChatResponse = {
      source: "rule_based_fallback",
      planningInput: ruleBasedPlanningInput({
        seed,
        messages: [],
        slots: {},
      }),
