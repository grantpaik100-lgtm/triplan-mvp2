...
export const secondaryQuestions: SecondaryQuestion[] = [
  ...
  },
  {
    id: "budgetSplit",
    section: "G",
    title: "예산을 어디에 더 쓰고 싶은가요?",
    help: "총 10점을 음식 / 활동·경험 / 숙소 / 쇼핑에 나눠 주세요.",
    type: "budgetSplit",
    required: false,
  },
  ...
  },
  {
    ...
    type: "textarea",
    required: false,
    placeholder: "예: 온천, 야경 보기, 한강 자전거, 전시 보기",
  },
  {
    id: "mustFoods",
    section: "F",
...

  {
    ...
    section: "X",
    title: "어떤 분위기의 장소가 더 좋나요?",
    help: "이번 여행에서 끌리는 공간의 분위기를 골라주세요.",
    type: "single",
    required: true,
    options: [
      "조용하고 여유로운 분위기",
  ...
  },
  {
    id: "nightPreference",
    section: "X",
    title: "밤 시간은 어떻게 보내는 것이 좋나요?",
    help: "야간 활동 선호를 반영해서 일정을 조절한다.",
    type: "single",
    required: true,
    options: [
      "밤에는 숙소에서 쉬고 싶다",
  ...
  {
    id: "activityIntensityPreference",
    section: "X",
    title: "어떤 정도의 활동감이 잘 맞나요?",
    help: "단순히 장소 수가 아니라 경험 자체의 활동감을 묻는 질문이다.",
    type: "single",
    required: true,
    options: [
      "가볍게 걷고 쉬는 정도가 좋다",
  ...
  },
  {
    id: "crowdTolerance",
    section: "X",
    title: "사람 많은 장소에 대한 선호는 어떤가요?",
    help: "붐비는 공간, 인기 스팟, 활기 있는 지역에 대한 선호를 반영한다.",
    type: "single",
    required: true,
    options: [
      "가능하면 한적한 곳이 좋다",
      "조용한 곳이 더 좋지만 조금은 괜찮다",
      "적당히 붐비는 정도는 괜찮다",
      "유명하고 활기차다면 괜찮다",
      "사람 많은 분위기도 오히려 좋다",
      "기타",
